...
function _setup(alg) {
  ...
  cfg.generateKey = async (opts) => {
    let params = cfg.configure("generateKey", Object.assign({}, opts));
  ...
  cfg.encrypt = async (opts) => {
    let params = cfg.configure("encrypt", Object.assign({}, opts));
  ...
  cfg.decrypt = async (opts) => {
    let params = cfg.configure("decrypt", Object.assign({}, opts));
